                ...
                <tr>
                    ...
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="<%=request.getContextPath()%>/patient/addAppointmentViewSecondServlet?departmentFirstId=${b.departmentId}&patientId=${patientId}">
            ...
            <tr>
                ...
                <td colspan="4">
                    <div class="pagelist">
                        ...
                        <a href="<%=request.getContextPath()%>/patient/addAppointmentViewServlet?pageNum=1">首页</a>

                        <c:if test="${pageInfo.pageNum > 1}">
                            <a href="<%=request.getContextPath()%>/patient/addAppointmentViewServlet?pageNum=${pageInfo.pageNum - 1}">上一页</a>
                        </c:if>
                        ...
                        <c:forEach begin="${begin}" end="${end}" var="currentPage">
                            <a href="<%=request.getContextPath()%>/patient/addAppointmentViewServlet?pageNum=${currentPage}" class="<c:if test="${pageInfo.pageNum eq currentPage}">current</c:if>">${currentPage}</a>
                        </c:forEach>
