...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />预约挂号中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <c:if test="${not empty AdminInfo}">
    ...
    <ul style="display:block">
      <li><a href="<%=request.getContextPath()%>/patient/rootAddConsultationServlet" target="right"><span class="icon-caret-right"></span>就诊</a></li>
