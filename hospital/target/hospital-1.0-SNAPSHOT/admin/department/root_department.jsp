        ...
        <table class="table table-hover text-center">
            <tr>
                ...
                <tr>
                    ...
                    <td><div class="button-group"> <a class="button border-main" href="<%=request.getContextPath()%>/backend/addDepartmentViewServlet?plevel=${d.departmentLevel}&pid=${d.departmentId}"><span class="icon-edit"></span> 添加二级科室</a> <a class="button border-red"  href="<%=request.getContextPath()%>/backend/dropDepartmentViewServlet?pid=${d.departmentId}" onclick="customClick1"><span class="icon-trash-o"></span> 删除</a> </div></td>
                </tr>
                </c:forEach>
        </table>
    </div>
